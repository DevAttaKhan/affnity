...
const AddEmployee = () => {
  ...
  const getOffices = () => {
    return axios
      .get('http://savvy.developerpro.co/api/office/get', {
        headers: {
  ...
  const getDept = () => {
    return axios
      .get('http://savvy.developerpro.co/api/department/get', {
        headers: {
          Authorization: 'Bearer ' + items.token,
        },
      })
  ...
  const getEmpType = () => {
    return axios
      .get('http://savvy.developerpro.co/api/employee_type/get', {
        headers: {
          Authorization: 'Bearer ' + items.token,
        },
      })
                        ...
                        {empTypes.map((item) => (
                          <p
                            ...
                            onClick={() => {
                              ...
                              setState({ ...state, employee_type_id: item.id });
                            }}
                          >
                            {item.type_name}
                          </p>
